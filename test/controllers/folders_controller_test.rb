...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { folderable_id: @folder.folderable_id, folderable_type: @folder.folderable_type, title: @folder.title, user_id: @folder.user_id } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { folderable_id: @folder.folderable_id, folderable_type: @folder.folderable_type, title: @folder.title, user_id: @folder.user_id } }
